     ...
     >
      <div className='flex items-center h-full justify-between w-[90%] xl:w-[80%] mx-auto'>
        ...
        <div className='flex items-center space-x-4'>
            {/* Join Now button */}
            <button className='bg-blue-950 dark:bg-white dark:text-black dark:hover:bg-grey-200 px-8 py-2.5 text-white font-bold rounded-lg hover:bg-black transition-all duration-300 cursor-pointer'>Join now 
            </button>
